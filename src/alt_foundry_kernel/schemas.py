...
SCHEMA_FILENAMES: dict[str, str] = {
    ...
    "cara-process": "cara-process.schema.json",
    "cara_process": "cara-process.schema.json",
    "causal-certificate": "causal-certificate.schema.json",
    "causal_certificate": "causal-certificate.schema.json",
    "certificate-composition": "certificate-composition.schema.json",
    "certificate_composition": "certificate-composition.schema.json",
    ...
    "evaluator-hierarchy": "evaluator-hierarchy.schema.json",
    "evaluator_hierarchy": "evaluator-hierarchy.schema.json",
    "evidence-budget": "evidence-budget.schema.json",
    "evidence_budget": "evidence-budget.schema.json",
    "evidence-split": "evidence-split.schema.json",
    "evidence_split": "evidence-split.schema.json",
    "finality-poua-ledger": "finality-poua-ledger.schema.json",
    "finality_poua_ledger": "finality-poua-ledger.schema.json",
    "guard-risk-record": "guard-risk-record.schema.json",
    "guard_risk_record": "guard-risk-record.schema.json",
    "proxy-bridge-record": "proxy-bridge-record.schema.json",
    "proxy_bridge_record": "proxy-bridge-record.schema.json",
    "federated-pooling": "federated-pooling.schema.json",
    "federated_pooling": "federated-pooling.schema.json",
    "foundry-control-state": "foundry-control-state.schema.json",
    "foundry_control_state": "foundry-control-state.schema.json",
    "foundry-transcript": "foundry-transcript.schema.json",
    "foundry_transcript": "foundry-transcript.schema.json",
    "mechanism-certificate": "mechanism-certificate.schema.json",
    "mechanism_certificate": "mechanism-certificate.schema.json",
    "measurement-spec": "measurement-spec.schema.json",
    "measurement_spec": "measurement-spec.schema.json",
    "non-reduction-audit": "non-reduction-audit.schema.json",
    "non_reduction_audit": "non-reduction-audit.schema.json",
    "opportunity-law": "opportunity-law.schema.json",
    "opportunity_law": "opportunity-law.schema.json",
    "portfolio-constraints": "portfolio-constraints.schema.json",
    "portfolio_constraints": "portfolio-constraints.schema.json",
    "phase-control-record": "phase-control-record.schema.json",
    "phase_control_record": "phase-control-record.schema.json",
    ...
    "confidence-accounting": "confidence-accounting.schema.json",
    "confidence_accounting": "confidence-accounting.schema.json",
    "estimator-input": "estimator-input.schema.json",
    "estimator_input": "estimator-input.schema.json",
    "release-manifest": "release-manifest.schema.json",
    "release_manifest": "release-manifest.schema.json",
    "recombination-estimate": "recombination-estimate.schema.json",
    "recombination_estimate": "recombination-estimate.schema.json",
    "root-finality-record": "root-finality-record.schema.json",
    "root_finality_record": "root-finality-record.schema.json",
    "sequential-decision": "sequential-decision.schema.json",
    "sequential_decision": "sequential-decision.schema.json",
    "submodular-selection-result": "submodular-selection-result.schema.json",
    "submodular_selection_result": "submodular-selection-result.schema.json",
    "transport-certificate": "transport-certificate.schema.json",
    "transport_certificate": "transport-certificate.schema.json",
    "transport-diagnostics": "transport-diagnostics.schema.json",
    "transport_diagnostics": "transport-diagnostics.schema.json",
    "transport-robustness": "transport-robustness.schema.json",
    "transport_robustness": "transport-robustness.schema.json",
}
